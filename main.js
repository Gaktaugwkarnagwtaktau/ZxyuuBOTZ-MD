...
global.reloadHandler = function (restatConn) {
  ...
  conn.welcome = 'wisss beban baru datang!!\nSelamat datang wahai Beban, di grup @subject\n\n@desc'
  conn.bye = 'Sipp! Beban grup Berkurang satu'
  conn.spromote = '@user sekarang di promote oleh admin!'
  conn.sdemote = '@user sekarang tidak lagi di promote!'
